...
//fuction to handle toggle between light and dark mood
let toggleMode = () => {
  ...
  // Update the SVG content based on the mode
  if (isLightMode) {
...
export default function Header() {
  return (
    <div className="header">
      <p className="app-name">TODO</p>
      <div className="svg" onClick={toggleMode}>
